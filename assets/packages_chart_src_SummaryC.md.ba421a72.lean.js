...
<script type="module">
  ...
  new SummaryC()
      ...
      ;
<\/script>
`)])],-1),S=a("",5),C=e("hpcc-vitepress",{style:{width:"100%",height:"600px"}},[e("pre",null,[e("code",null,`<div id="placeholder" style="height:400px">
</div>
<script type="module">
  import { SummaryC } from "@hpcc-js/chart";
...
<script type="module">
  ...
  new SummaryC()
      ...
      ;
<\/script>
`)])],-1),w=a("",3);function x(T,I,k,P,z,A){const t=s("ClientOnly");return i(),c("div",null,[d,u,o(t,null,{default:l(()=>[p]),_:1}),h,_,o(t,null,{default:l(()=>[y]),_:1}),S,o(t,null,{default:l(()=>[C]),_:1}),f,o(t,null,{default:l(()=>[v]),_:1}),b,o(t,null,{default:l(()=>[g]),_:1}),w])}var j=r(m,[["render",x]]);export{B as __pageData,j as default};
