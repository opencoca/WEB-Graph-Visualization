...
<script type="module">
  ...
  new Radar()
      ...
      ;
<\/script>
`)])],-1),R=s('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:Radar"><pre><code></code></pre></div>',3);function x(P,S,V,w,C,A){const a=i("ClientOnly");return d(),o("div",null,[p,h,t(a,null,{default:l(()=>[u]),_:1}),_,m,t(a,null,{default:l(()=>[f]),_:1}),b,g,v,t(a,null,{default:l(()=>[y]),_:1}),R])}var N=r(c,[["render",x]]);export{z as __pageData,N as default};
