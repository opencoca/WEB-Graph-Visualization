import{_ as a,c as t,b as p,w as o,a as u,r as c,o as e,d as n}from"./app.7b1078cc.js";const h='{"title":"@hpcc-js/map-deck","description":"","frontmatter":{},"headers":[{"level":2,"title":"Exported Widgets","slug":"exported-widgets"},{"level":2,"title":"Stand-alone HTML Example","slug":"stand-alone-html-example"}],"relativePath":"packages/map-deck/README.md"}',l={},i=u("",6),k=n("hpcc-vitepress",{style:{width:"100%",height:"600px"}},[n("pre",null,[n("code",null,`<div id="target" style="width:100%;height:600px">
</div>
<script type="module">
...
<\/script>
`)])],-1);function q(r,g,d,L,G,A){const s=c("ClientOnly");return e(),t("div",null,[i,p(s,null,{default:o(()=>[k]),_:1})])}var m=a(l,[["render",q]]);export{h as __pageData,m as default};
