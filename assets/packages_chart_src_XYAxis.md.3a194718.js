...
<script type="module">
  ...
  new XYAxis()
      ...
      ;
<\/script>
`)])],-1),v=a('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-hidden="true">#</a></h2><h2 id="published-properties" tabindex="-1">Published Properties <a class="header-anchor" href="#published-properties" aria-hidden="true">#</a></h2><div class="language-@hpcc-js/chart:XYAxis"><pre><code></code></pre></div>',3);function k(C,P,S,I,Y,V){const t=r("ClientOnly");return h(),o("div",null,[p,i(t,null,{default:s(()=>[c]),_:1}),x,m,i(t,null,{default:s(()=>[u]),_:1}),_,A,g,i(t,null,{default:s(()=>[y]),_:1}),f,i(t,null,{default:s(()=>[w]),_:1}),T,i(t,null,{default:s(()=>[b]),_:1}),v])}var O=l(d,[["render",k]]);export{D as __pageData,O as default};
