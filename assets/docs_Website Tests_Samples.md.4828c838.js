import{_ as n,c as a,o as s,a as t}from"./app.7b1078cc.js";const q='{"title":"Sample","description":"","frontmatter":{},"headers":[{"level":2,"title":"Samples","slug":"samples"},{"level":3,"title":"Code and Sample (Splitter)","slug":"code-and-sample-splitter"},{"level":3,"title":"Code and Sample (Tabbed)","slug":"code-and-sample-tabbed"},{"level":3,"title":"Just a Sample (no code)","slug":"just-a-sample-no-code"},{"level":3,"title":"Just code (no visible sample)","slug":"just-code-no-visible-sample"},{"level":2,"title":"API","slug":"api"},{"level":2,"title":"Published Properties","slug":"published-properties"}],"relativePath":"docs/Website Tests/Samples.md"}',e={},o=t(`<h1 id="sample" tabindex="-1">Sample <a class="header-anchor" href="#sample" aria-hidden="true">#</a></h1><h2 id="samples" tabindex="-1">Samples <a class="header-anchor" href="#samples" aria-hidden="true">#</a></h2><h3 id="code-and-sample-splitter" tabindex="-1">Code and Sample (Splitter) <a class="header-anchor" href="#code-and-sample-splitter" aria-hidden="true">#</a></h3><div class="language-sample-code-split"><pre><code>import { Column } from &quot;@hpcc-js/chart&quot;;
