import{_ as t,c as p,b as a,w as e,a as l,d as n,e as o,r as c,o as r}from"./app.7b1078cc.js";const R='{"title":"Compiler","description":"","frontmatter":{},"headers":[{"level":2,"title":"Minimal JSON Notebook","slug":"minimal-json-notebook"},{"level":2,"title":"Hello World Example","slug":"hello-world-example"},{"level":2,"title":"MoreExamples","slug":"moreexamples"}],"relativePath":"packages/observablehq-compiler/src/compiler.md"}',i={},u=l(`<h1 id="compiler" tabindex="-1">Compiler <a class="header-anchor" href="#compiler" aria-hidden="true">#</a></h1><p>Observable HQ Notebook Compiler and Interpreter</p><h2 id="minimal-json-notebook" tabindex="-1">Minimal JSON Notebook <a class="header-anchor" href="#minimal-json-notebook" aria-hidden="true">#</a></h2><p>While the compiler supports and persists the entire Observable HQ Notebook (v3), it only needs a minimal subset to actually function:</p><div class="language-ts"><pre><code><span class="token keyword">interface</span> <span class="token class-name">Notebook</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>Putting it all together:</p>`,16),d=n("hpcc-vitepress",{preview_height_ratio:"0.4",style:{width:"100%",height:"400px"}},[n("pre",null,[n("code",null,`<div id="placeholder" style="height:100%;overflow-y:scroll">
</div>
<script type="module">
