import{_ as o,c as s,b as a,w as i,a as l,d as e,e as n,r,o as p}from"./app.7b1078cc.js";const z='{"title":"Line","description":"","frontmatter":{},"headers":[{"level":2,"title":"API","slug":"api"},{"level":2,"title":"Published Properties","slug":"published-properties"}],"relativePath":"packages/chart/src/Line.md"}',c={},d=l("",2),h=e("hpcc-vitepress",{style:{width:"100%",height:"600px"}},[e("pre",null,[e("code",null,`<div id="placeholder" style="height:400px">
</div>
<script type="module">
...
<script type="module">
  ...
  new Line()
      ...
      ;
<\/script>
`)])],-1),S=l("",3);function C(P,D,k,B,I,j){const t=r("ClientOnly");return p(),s("div",null,[d,a(t,null,{default:i(()=>[h]),_:1}),u,a(t,null,{default:i(()=>[_]),_:1}),m,f,x,g,a(t,null,{default:i(()=>[v]),_:1}),y,A,w,b,a(t,null,{default:i(()=>[V]),_:1}),T,a(t,null,{default:i(()=>[L]),_:1}),S])}var $=o(c,[["render",C]]);export{z as __pageData,$ as default};
