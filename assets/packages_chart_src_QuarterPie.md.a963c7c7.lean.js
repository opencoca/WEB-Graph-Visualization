...
<script type="module">
  ...
  new QuarterPie()
      ...
      ;
<\/script>
`)])],-1),P=l("",3);function f(m,g,v,x,y,b){const r=d("ClientOnly");return o(),s("div",null,[h,p,a(r,null,{default:n(()=>[u]),_:1}),a(r,null,{default:n(()=>[_]),_:1}),P])}var V=i(c,[["render",f]]);export{Q as __pageData,V as default};
